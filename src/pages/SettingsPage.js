...
import GoogleSheetsSection from '../components/GoogleSheetsSection.js';
...
class SettingsPage extends BasePage {
    ...
    mountGoogleSheetsSection() {
        const googleSheetsContainer = document.getElementById(ELEMENT_IDS.GOOGLE_SHEETS_SECTION);
        ...
        this.addComponent(this.googleSheetsSection);
    }
